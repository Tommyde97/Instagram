...
//  Instagram
//
//  Created by Tomas D. De Andrade Gomes on 8/21/23.
//
...
class NotificationsFollowEventTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        followButton.frame = CGRect(x: contentView.width - 10 - size,
        ...
        label.frame = CGRect(x: profileImageView.right+5,
                             y: 0,
                             width: contentView.width-size-profileImageView.width-21,
